...
发布包：[OfficeShiftScroll 1.0.0 Release](https://github.com/zvl-ab/OfficeShiftScroll/releases/tag/v1.0.0)，下载 `OfficeShiftScroll-1.0.0-x64.zip`，解压后运行 `Install.cmd`。源码仓库不再包含 Output 文件夹。
